	...
	<script>
		...
		function displaySchedule(){
			...
			for (var i = 0; i < count; i++) {
				...
				document.getElementsByClassName(div1)[0].style.height = "7px";
				document.getElementsByClassName(div1)[0].style.marginBottom = "-9px";
				document.getElementsByClassName(div2)[0].style.top = -1361 + (positionStart * 56) +"px";
				document.getElementsByClassName(div2)[0].style.height = 46 + (timeDiff * 56) + "px";
				document.getElementsByClassName(div2)[0].style.marginBottom = -44 -(timeDiff * 56) + "px";
			...
			for (var i = 0; i < countAll; i++) {
				...
				document.getElementsByClassName(div1All)[0].style.height = "7px";
				document.getElementsByClassName(div1All)[0].style.marginBottom = "-9px";
				document.getElementsByClassName(div2All)[0].style.top = -1361 + (positionStart * 56) +"px";
				document.getElementsByClassName(div2All)[0].style.height = 46 + (timeDiff * 56) + "px";
				document.getElementsByClassName(div2All)[0].style.marginBottom = -44 -(timeDiff * 56) + "px";
